                    ...
                    <form action="/admin/slide-banner/store" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="CTA Label" id="cta_label"
                                    name="cta_label" required onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="cta_url" class="form-control-label">CTA URL</label>
                                <input class="form-control" type="text" placeholder="CTA URL" id="cta_url"
                                    name="cta_url" required onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group">
